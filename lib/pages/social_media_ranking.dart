...
class SocialMediaRankingPage extends StatelessWidget {
  final TextEditingController dateController = TextEditingController();

  SocialMediaRankingPage({super.key});

  Future<void> _selectDate(BuildContext context, SocialMediaProvider provider) async {
    ...
    return Consumer<SocialMediaProvider>(
      builder: (context, provider, _) {
        ...
        final List<TvRating> top10Sorted = dramas
            ...
            .toList()
          ..sort((a, b) => a.ml_ratings!.compareTo(b.ml_ratings!));
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Social Media Ranking", style: Theme.of(context).textTheme.headlineMedium),
                    SizedBox(
                      width: 120,
